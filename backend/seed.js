...
const generateProducts = (cats) => [
  ...
  },
  {
    ...
    description: 'Advanced fitness and health tracker with built-in GPS, heart rate on equipment, 40+ exercise modes, and sleep tracking. Includes a 6-month Premium membership.',
    shortDescription: 'Advanced fitness tracker with GPS & ECG',
    price: 14999,
    discountPercent: 10,
    category: cats['Sports & Fitness'],
    brand: 'Fitbit',
    ...
    numReviews: 1205,
    soldCount: 800,
    tags: ['fitness', 'tracker', 'fitbit', 'watch'],
    images: [{ url: 'https://images.unsplash.com/photo-1575311373937-040b8e1fd5b6?w=600', alt: 'Fitbit Tracker', isPrimary: true }],
    specifications: [
  ...
  },
  {
    ...
    description: '100,000 years ago, at least six human species inhabited the earth. Today there is just one. Us. Homo sapiens. A groundbreaking narrative of humanity.',
    shortDescription: 'The multi-million copy bestseller by Yuval Noah Harari',
    price: 499,
    discountPercent: 20,
    category: cats.Books,
    brand: 'Vintage Books',
    ...
    numReviews: 45000,
    soldCount: 15000,
    tags: ['book', 'history', 'non-fiction', 'bestseller'],
    images: [{ url: 'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?w=600', alt: 'Sapiens Book', isPrimary: true }],
  },
  {
    name: 'CeraVe Hydrating Facial Cleanser',
    description: 'Developed with dermatologists, this non-foaming face wash contains 3 essential ceramides and hyaluronic acid to hydrate and restore the skin barrier.',
    shortDescription: 'Gentle, non-foaming cleanser with ceramides',
    price: 899,
    discountPercent: 0,
    category: cats['Beauty & Health'],
    brand: 'CeraVe',
    ...
    numReviews: 8900,
    soldCount: 6500,
    tags: ['skincare', 'cleanser', 'cerave', 'face', 'health'],
    images: [{ url: 'https://images.unsplash.com/photo-1629198688000-71f23e745b6e?w=600', alt: 'CeraVe Cleanser', isPrimary: true }],
  },
  {
    name: 'ASUS ROG Strix G16 Gaming Laptop',
    description: 'Draw more frames and win more games with the brand new ROG Strix G16. Powered by a 13th Gen Intel Core i7 processor and an NVIDIA GeForce RTX 4060 GPU.',
    shortDescription: 'Intel i7 13th Gen, RTX 4060, 165Hz Display',
    price: 145990,
    discountPercent: 12,
    category: cats.Electronics,
    brand: 'ASUS',
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1603302576837-37561b2e2302?w=600', alt: 'ASUS ROG Laptop', isPrimary: true }],
    specifications: [
  ...
  },
  {
    ...
    description: 'A sleek and modern coffee table featuring a solid oak wood top and black powder-coated steel legs. Perfect for contemporary living rooms.',
    shortDescription: 'Solid oak wood top with steel legs',
    price: 12499,
    discountPercent: 15,
    category: cats['Home & Living'],
    brand: 'UrbanFurnish',
    ...
    numReviews: 128,
    soldCount: 210,
    tags: ['furniture', 'table', 'living-room', 'wood'],
    images: [{ url: 'https://images.unsplash.com/photo-1533090481720-856c6e3c1fdc?w=600', alt: 'Coffee Table', isPrimary: true }],
  },
];
